...
- It is a Serverless Service like Azure CosmosDB.

- Azure App Service is not Serverless Service, as you have to provide Azure App Service Plan (Free/Basic/Standard/Premium/Isolated)

## How to create an Azure Function App

**Hosting Plan**

- Hosting Plan : Flex Consumption (Default)
...
- Zone Redundancy : Enabled (Default)

**Storage**

- Storage Account:
  - Accounts must support blobs, queue, and Table storage (General Purpose v2)
