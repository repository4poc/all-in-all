...
class Program
{
    static async Task Main(string[] args)
    {
        ...
        Func<CustomerPayload, CustomerPayload> validateFunc = payload =>
        {
            ...
            return payload with { IsValidated = false, Status = isValid ? "Validated" : "Rejected" };
        };
        ...
        var initialPayload = new CustomerPayload("Contoso Pharmaceuticals", "Healthcare", false, "New");
